...
let link = document.createTextNode("First link");
a.appendChild(link)
...
ul2.appendChild(li2)
li2 = document.createElement ("li")
li2.innerHTML = 'Create a new HTML file, called ' +'<b>index.html</b>'+ ', which has only one ' +'&lt'  +"h1"+ '&gt' +' tag with "Hello, World!" message ' +"("+ "<b>1 point</b>"+")."
li2.style.color = "green"
